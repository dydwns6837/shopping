   ...
   <section>
      <div class="d-flex">
         ...
         <div class="ml-5 w-25">
            ...
            <div>
               <button type="button" class="btn btn-success col-12 mt-3"
                  id="orderProductBtn">구매하기</button>
            </div>
            <div>
               <button type="button" class="btn btn-warning col-12 mt-3"
                  id="addCartBtn">장바구니</button>
            </div>
            <div>
